...
namespace FisioterapiaUlatskawa.Models
{
    public class WebAPIRecurringEvent
    {
        ...
        public static explicit operator WebAPIRecurringEvent(SchedulerRecurringEventVM schedulerEvent)
        {
        ...
        public static explicit operator SchedulerRecurringEventVM(WebAPIRecurringEvent schedulerEvent)
        {
            return new SchedulerRecurringEventVM
            {
                Id = schedulerEvent.id,
